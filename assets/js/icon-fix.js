(() => {
  const processImage = (img) => {
    ...
    if (/inkwell-fan\.png/.test(originalSrc) && !originalSrc.includes('inkwell-fan.png?v=inkwell2')) {
      img.src = originalSrc.replace(/inkwell-fan\.png(?:\?[^#]*)?/, 'inkwell-fan.png?v=inkwell2');
    }
