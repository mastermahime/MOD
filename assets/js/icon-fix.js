(() => {
  const processImage = (img) => {
    ...
    if (/inkwell-fan\.(?:png|svg)/.test(originalSrc) && !originalSrc.includes('inkwell-fan.svg?v=inkwell5')) {
      img.src = originalSrc.replace(/inkwell-fan\.(?:png|svg)(?:\?[^#]*)?/, 'inkwell-fan.svg?v=inkwell5');
    }
